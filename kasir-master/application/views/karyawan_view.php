              ...
              <thead>
                ...
                <tbody>
                   ...
                   foreach ($karyawan as $m) { ?>
                    ...
                    <a href="<?= base_url('karyawan/delete/'); ?><?= $m['id_karyawan']; ?>"><button type="submit"  class="btn btn-sm btn-primary" name="hapus">Hapus</button></a></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </thead>
...
<script>
  var readUrl = '<?php echo site_url('karyawan/read') ?>';
  var addUrl = '<?php echo site_url('karyawan/add') ?>';
  var deleteUrl = '<?php echo site_url('karywan/delete') ?>';
  var get_kategoriUrl = '<?php echo site_url('karyawan/get_kategori') ?>';
</script>
